...
public class Laba4Ex3Stream {
    ...
    @Test
    void test() {
        assertEquals(List.of(9, 3, 7, 6, 4, 2), sortArrayUpToFirstX(Arrays.asList(9, 3, 7, 6, 4, 2), 1));
        assertEquals(List.of(9, 7, 6, 4, 3, 1, 2), sortArrayUpToFirstX(Arrays.asList(9, 3, 7, 6, 4, 1, 2), 1));
        assertEquals(List.of(1, 3, 5, 4, 2, 9, 7), sortArrayUpToFirstX(Arrays.asList(1, 3, 5, 4, 2, 9, 7), 1));
        assertEquals(List.of(77, 55, 12, 9, 7, 5, 4, 3, 2, 77, 647, 89),
                sortArrayUpToFirstX(Arrays.asList(77, 3, 5, 4, 2, 9, 7, 12, 55, 77, 647, 89), 77));
...
//        return listNumber.reversed().stream()
//                .dropWhile(integer -> integer != x)
//                .sorted()
//                .toList();
